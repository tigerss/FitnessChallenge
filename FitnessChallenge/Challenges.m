...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle: @"Selected challenge" message: [NSString stringWithFormat:@"Will start %@",selectedCell.textLabel.text] delegate: nil cancelButtonTitle:@"OK" otherButtonTitles:nil];

...
// Challenge Table
FOUNDATION_EXPORT NSString *const TABLE_CHALLENGE_CHALLENGER_ID; // va fi id-ul celui ce initiaza challenge-ul
FOUNDATION_EXPORT NSString *const TABLE_CHALLENGE_EXERCISE_NAME;
FOUNDATION_EXPORT NSString *const TABLE_CHALLENGE_USER_ID;
...
FOUNDATION_EXPORT NSString *const TABLE_BADGE_USER_USER_ID;
...
@property NSInteger* challengerId;
